...
On multi-app pooled (n=200): $43\%$ aligned top-1. This exceeds
the proposed LLM-grounded diagnoser on the multi-app scope and is therefore
reported as a negative/qualifying result, not as support for diagnostic
superiority. It is also an \emph{upper bound} because the input is an
operator-curated kubectl-equivalent bundle; the comparability threat is
discussed in \S\ref{sec:threats}.
