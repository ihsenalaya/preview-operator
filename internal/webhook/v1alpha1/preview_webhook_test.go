...
var _ = Describe("Preview Webhook", func() {
	var (
		obj       *platformv1alpha1.Preview
		oldObj    *platformv1alpha1.Preview
		validator PreviewCustomValidator
	...
	Context("When creating Preview under Defaulting Webhook", func() {
	...
	Context("When creating or updating Preview under Validating Webhook", func() {
		validPreview := func() *platformv1alpha1.Preview {
			return &platformv1alpha1.Preview{
				Spec: platformv1alpha1.PreviewSpec{
					Branch:       "demo",
					PRNumber:     1,
					Image:        "ghcr.io/ihsenalaya/preview-demo-app:0.5.1",
